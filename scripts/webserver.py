...
ENV = {
    ...
    "INFINITY_MODEL_ID": "jinaai/jina-clip-v1;michaelfeil/bge-small-en-v1.5;mixedbread-ai/mxbai-rerank-xsmall-v1;philschmid/tiny-bert-sst2-distilled;Alibaba-NLP/gte-Qwen2-7B-instruct;",
    ...
    "INFINITY_MODEL_WARMUP": "false;false;false;false;false;",
    "INFINITY_BATCH_SIZE": "32;32;32;32;32;",
    # One-off args
...
app = App("infinity-serve", image=image)


# Run a web server on port 7997 and expose the Infinity embedding server
@app.function(
    # allow up to 100 requests pending on a single container
    ...
    # scale to zero
    keep_warm=0,
    # use a more powerful GPU for larger models
    gpu=gpu.A100(),
)
@web_server(
    PORT,
